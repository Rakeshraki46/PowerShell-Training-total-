#Step 1:Defining the app registration details in another folder and it should be present in same directory
...
$users = Import-Csv -Path "C:\Users\Rakesh\Downloads\UsersMy.csv" #function #cmdlets in ps or fun
