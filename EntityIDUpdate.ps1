...
#>
$displayName = "VerizonPOC12" # SAML application name
...
# --- Add GROUP CLAIMS to manifest (including cloud-only group name emission) ---
$groupClaimsBody = @{
    ...
    optionalClaims = @{
        saml2Token = @(
            @{
                ...
                #emitGroupName = $true   # This is the KEY for your requirement!
            }
        )
    }
}
